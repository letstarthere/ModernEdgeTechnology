...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add hover effects for interactive elements (excluding videos, images, and code sample)
    const interactiveElements = document.querySelectorAll('.why-ringa, .team-description, .product-item');
